...
const ProductFilterBar: React.FC<ProductFilterBarProps> = ({
  ...
  <div className="w-full max-w-6xl bg-[#f7f7f7] rounded-2xl shadow sm:flex hidden flex-wrap items-center px-2 md:px-4 py-2 md:py-4 gap-2 md:gap-3 mb-6 md:mb-10 overflow-x-auto">
    {/* Guideline pill */}
    <div
    ...
    >
      ...
      {/* Dropdown */}
      {showGuidelineDropdown && (
        <div ref={guidelineDropdownRef} className="absolute left-0 top-full mt-2 bg-white border rounded-lg shadow-lg z-30 w-[95vw] max-w-lg md:w-[700px] py-2 flex flex-col md:flex-row gap-2 md:gap-8">
